...
const kPrimaryColor = Color(0xFF5EA7FF);
const ButtonColor = Color(0xFF5EA7FF);
...
const String kEmailNullError = "Введите почту";
const String kInvalidEmailError = "Адреса не существует";
